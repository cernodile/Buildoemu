...
bool MySQLManager::Init(string name, string password, string host, int port)
{
	...
	if (!mysql_real_connect(m_conn, host.c_str(), name.c_str(), password.c_str(), NULL, port, NULL, 0))
	{
		ShowError("");
